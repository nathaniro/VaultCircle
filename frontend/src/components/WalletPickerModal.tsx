...
export default function WalletPickerModal() {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/70 px-4">
      <div className="w-full max-w-2xl overflow-hidden rounded-[30px] border border-white/10 bg-slate-950 shadow-[0_30px_120px_rgba(2,6,23,0.65)]">
        <div className="flex items-start justify-between border-b border-white/10 px-6 py-6 md:px-8">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-semibold text-white">Choose your Stacks Testnet signer</h2>
            ...
            return (
              <div
                ...
                className={`rounded-[24px] border p-5 transition-colors ${
                  isSelected ? "border-cyan-400/30 bg-cyan-400/[0.08]" : "border-white/10 bg-white/[0.04]"
                }`}
              >
                <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                  <div>
                    ...
                    <p className="mt-2 max-w-xl text-sm leading-6 text-slate-400">{wallet.description}</p>
                  </div>
